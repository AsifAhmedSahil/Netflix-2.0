    ...
    <div>
      <div className="w-full h-screen">
        <img
          ...
          src="https://assets.nflxext.com/ffe/siteui/vlv3/b321426e-35ae-4661-b899-d63bca17648a/044b9365-d6b8-4e45-98b0-3ace7d99ffd3/BD-en-20220926-popsignuptwoweeks-perspective_alpha_website_medium.jpg"
          alt="/"
        />
          ...
          <div className="max-w-[450px] h-[660px] bg-black/75 mx-auto text-white">
            <div className="max-w-[320px] mx-auto py-16">
              ...
              <form
                ...
                className="flex flex-col w-fulls py-4"
              >
                <input
